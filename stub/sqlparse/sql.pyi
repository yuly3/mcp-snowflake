...
class TokenList(Token):
    ...
    def token_next_by(self, i: Any = ..., m: Any = ..., t: Any = ..., idx: int = ..., end: int | None = ...) -> tuple[int, Token] | tuple[None, None] | None: ...
    ...
    def token_prev(self, idx: int, skip_ws: bool = ..., skip_cm: bool = ...) -> tuple[None, None] | tuple[int, Token] | None:
